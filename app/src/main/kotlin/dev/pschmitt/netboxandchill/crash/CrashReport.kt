...
/** Stores one report synchronously so it survives the process termination caused by a crash. */
...
/** Formats only diagnostic data and redacts the token forms used by NetBox and Chill. */
object CrashReportFormatter {
    ...
    fun format(
        ...
        return buildString {
            appendLine("NetBox and Chill crash report")
    ...
    internal fun sanitize(value: String): String =
        value
            .replace(netBoxToken, "[REDACTED_NETBOX_TOKEN]")
