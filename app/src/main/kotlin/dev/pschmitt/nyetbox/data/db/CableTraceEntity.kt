 ...
 * (`api/dcim/<component>/<id>/trace/`), keyed by the termination it was traced from -
 * [traceEndpointPath]/[traceObjectId] - since the trace endpoint lives on the termination, not the
 * cable itself. [json] is the raw serialized 3-element array for that segment.
 */
@Entity(
